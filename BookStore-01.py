...
class Publisher:
    def __init__(self, name: Optional[int], address: Optional[int], phone: Optional[int], url: Optional[int]):
        self.name = name
...
class Author:
    def __init__(self, name: Optional[int], address: Optional[int], url: Optional[int]):
        self.name = name
        self.address = address
        self.url = url
...
class Book:
    def __init__(self, isbn: Optional[int], publisher_name: Optional[int], author_name: Optional[int], author_address: Optional[int], year: List[int], title: Optional[int], price: float):
        self.isbn = isbn
...
class Warehouse:
    def __init__(self, code: List[int], phone: Optional[int], address: Optional[int]):
        self.code = code
        self.phone = phone
        self.address = address
        self.warehouse_books = []  # One-to-Many relationship with Warehouse_Book
...
class Warehouse_Book:
    def __init__(self, warehouse_code: List[int], book_isbn: Optional[int], count: List[int]):
        self.warehouse_code = warehouse_code
        self.book_isbn = book_isbn
        self.count = count

class Customer:
    def __init__(self, email: Optional[int], name: Optional[int], phone: Optional[int], address: Optional[int]):
        self.email = email
        self.name = name
        self.phone = phone
        self.address = address
...
class ShoppingBasket:
    def __init__(self, id: List[int], customer_email: Optional[int]):
        self.id = id
        self.customer_email = customer_email
        self.shoppingbasket_books = []  # One-to-Many relationship with ShoppingBasket_Book

class ShoppingBasket_Book:
    def __init__(self, shoppingbasket_id: List[int], book_isbn: Optional[int], count: List[int]):
...
def get_books_in_warehouse(warehouse_code: Optional[int]) -> List[dict]:
...
def get_author_of_book(isbn: Optional[int]) -> str:
...
def get_average_price_by_publisher(publisher_name: Optional[int]) -> float:
